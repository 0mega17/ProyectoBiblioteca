...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <input type="text" id="buscador" placeholder="Buscar libro..." class="form-control w-50 mx-auto mb-3">
                                <!-- por la parte del buscador su logica se basa en lo siguiente cada que se cargue esa pagina lo que se hara es tirarle una consulta
                                 la cual me trae todos los libros que seran almacenados en un arreglo arreglo el cual sera recorrido en tiempo real y que mostrara 
    ...
    <script src="../ASSETS/JS/buscarLibro.js"></script>
