...
<head>
  ...
  <meta name="description" content="Panel de administración - Biblioteca">
  <meta name="author" content="AdminKit">
  <meta name="keywords" content="biblioteca, libros, admin, dashboard, template, responsive">

  <link rel="preconnect" href="https://fonts.gstatic.com">
  <link rel="shortcut icon" href="../ASSETS/IMG/icono.png" />
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">

  <title>Crear Libro | Biblioteca</title>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form id="formularioCrearLibro">
                    ...
                    <input type="text" class="form-control mb-3" placeholder="Ingrese Título del libro" name="tituloLibro">

                    <label for="">Autor</label>
                    <input type="text" class="form-control mb-3" placeholder="Ingrese Autor del libro" name="autorLibro">

                    <label for="">ISBN</label>
                    <input type="text" class="form-control mb-3" placeholder="Ingrese ISBN" name="isbnLibro" id="isbnLibro">

                    <label for="">Categoría</label>
                    <input type="text" class="form-control mb-3" placeholder="Ingrese Categoría del libro" name="categoriaLibro">

                    <label for="">Disponibilidad</label>
                    <input type="text" class="form-control mb-3" placeholder="Disponible / No disponible" name="disponibilidadLibro">

                    <label for="">Cantidad</label>
                    <input type="number" class="form-control mb-3" placeholder="Ingrese cantidad de copias" name="cantidadLibro">

                    <button type="submit" class="btn btn-success">Ingresar libro</button>
                  </form>
                </div>
              </div>
            </div>
